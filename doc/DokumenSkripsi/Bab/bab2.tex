...
Direktori \texttt{app} berisi kode program yaitu setiap bagian pada aplikasi yang membutuhkan penghimpunan seperti file Java dan \textit{view}. Saat pertama kali proyek Play Framework dibuat, direktori \textit{app} berisi seperti pada gambar
\begin{figure}[H]
	\centering
