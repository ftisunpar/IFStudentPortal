...
Diagram kelas analisis untuk IT Student Portal ditunjukkan pada gambar \ref{fig:3_class_diagram}.
	\begin{figure}[H]
		...
		\end{figure}
Kelas-kelas dari package SIA Models telah dibahas pada subbab \ref{sec:siamodels}. Sedangkan enjelasan dari kelas-kelas lainnya sebagai berikut:
\begin{enumerate}
	\item Controller\\
	...
	\item Application\\
	Kelas ini merupakan controller pada IT Student Portal yang berfungsi untuk menghubungkan \textit{model} dengan \textit{view}. 
	\item Scraper\\
