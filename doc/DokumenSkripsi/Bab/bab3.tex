...
Pada bab ini akan dijelaskan mengenai analisis Portal Akademik Mahasiswa, analisis kebutuhan Informatika Student Portal, analisis komunikasi Portal Akademik Mahasiswa meliputi kasus \textit{login}, nilai, jadwal, dan \textit{logout}, analisis arsitektur Informatika Student Portal, analisis \textit{use case} beserta skenario dari masing-masing \textit{use case}, dan analisis kelas.
