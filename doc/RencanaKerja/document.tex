...
\section{Deskripsi}
Student Portal UNPAR merupakan sistem informasi berbasis \textit{web} yang digunakan oleh mahasiswa UNPAR. 
...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\item Menganalisa fitur-fitur yang akan ditambahkan dalam IT Student Portal.
	\end{enumerate}
