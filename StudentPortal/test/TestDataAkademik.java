 ...
 *
 */
public class TestDataAkademik extends FunctionalTest {

	public TestDataAkademik() throws IOException {
		super();
	}

	/**
	 * Jika pengguna sudah memiliki riwayat nilai, akan ditampilkan ringkasan
	 * data akademik mahasiswa berupa IPS semester terakhir, IPK, SKS lulus,
