...
/**
 * Kelas untuk membaca conf\functionaltest.conf File tersebut berisi id dan
 * password yang digunakan untuk test-test yang akan dilakukan Kelas ini
 * bersifat singleton
 * 
 * @author FTIS\i13006
 *
...
public class FileConfReader {
	...
	FileConfReader() throws IOException {
	 ...
	 */
	public static FileConfReader getObjFileConfReader() throws IOException{
